...
fun Apex.toPoint(): Point {
    return when (this) {
        Apex._0 -> Point(0.0, -DISTANCE_BETWEEN_CENTER_AND_APEX)
        Apex._2 -> Point(+DISTANCE_BETWEEN_CENTER_AND_SIDE, -DISTANCE_BETWEEN_MIDDLE_OF_SIDE_AND_APEX)
        Apex._4 -> Point(+DISTANCE_BETWEEN_CENTER_AND_SIDE, +DISTANCE_BETWEEN_MIDDLE_OF_SIDE_AND_APEX)
        Apex._6 -> Point(0.0, +DISTANCE_BETWEEN_CENTER_AND_APEX)
        Apex._8 -> Point(-DISTANCE_BETWEEN_CENTER_AND_SIDE, +DISTANCE_BETWEEN_MIDDLE_OF_SIDE_AND_APEX)
        Apex._10 -> Point(-DISTANCE_BETWEEN_CENTER_AND_SIDE, -DISTANCE_BETWEEN_MIDDLE_OF_SIDE_AND_APEX)
    }
}